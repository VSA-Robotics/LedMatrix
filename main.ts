...
namespace LedMatrix {
    ...
    const font: FontMap = {
        'A': [0x2E, 0x78, 0x78, 0x78, 0x2E],
        'B': [0x7E, 0x6A, 0x4A, 0x4A, 0x1E],
        'C': [0x3C, 0x42, 0x40, 0x42, 0x24],
        'D': [0x7E, 0x62, 0x42, 0x7E, 0x40],
        'E': [0x7E, 0x4A, 0x4A, 0x4A, 0x42],
        'F': [0x7E, 0x68, 0x48, 0x48, 0x40],
        ...
        'P': [0x7E, 0x68, 0x48, 0x48, 0x40],
        'Q': [0x3C, 0x60, 0x60, 0x7E, 0x40],
        'R': [0x7E, 0x68, 0x48, 0x44, 0x40],
        'S': [0x0A, 0x4A, 0x4A, 0x74, 0x40],
        'T': [0x40, 0x40, 0x7E, 0x40, 0x40],
        'U': [0x7C, 0x40, 0x40, 0x40, 0x7E],
        'V': [0x7C, 0x40, 0x42, 0x40, 0x7C],
        'W': [0x7C, 0x42, 0x1C, 0x42, 0x7C],
