...
namespace LedMatrix {
    ...
    // Font definition for A-Z, 0-9, ?, !, % (5 columns per character, 8 rows high, rotated 90° clockwise)
    const font: { [key: string]: number[] } = {
        'A': [0x38, 0x38, 0x38, 0xF8, 0x38],
        'B': [0xF8, 0xF8, 0xF8, 0x38, 0xF8],
        'C': [0x78, 0xF8, 0xF8, 0x80, 0x78],
        'D': [0xF8, 0xF8, 0xF8, 0x88, 0x78],
        'E': [0xF8, 0xF8, 0xF8, 0x80, 0xF8],
        'F': [0x00, 0xF8, 0xF8, 0xF8, 0xF8],
        'G': [0x78, 0xF8, 0xF8, 0xB8, 0x38],
        'H': [0xF8, 0xF8, 0xF8, 0xF8, 0xF8],
        'I': [0x78, 0x78, 0xF8, 0x78, 0x78],
        'J': [0x78, 0xF8, 0xF8, 0x78, 0x70],
        'K': [0xF8, 0xF8, 0xF8, 0xD8, 0xB8],
        'L': [0xF8, 0xF8, 0xF8, 0xF8, 0x00],
        'M': [0xF8, 0xD8, 0xE8, 0xD8, 0xF8],
        'N': [0xF8, 0xB8, 0xD8, 0xE8, 0xF8],
        'O': [0x78, 0xF8, 0xF8, 0xF8, 0x78],
        'P': [0x00, 0xF8, 0xF8, 0xF8, 0x78],
        'Q': [0x7A, 0xFA, 0xFA, 0xFA, 0x7A],
        'R': [0xB8, 0xD8, 0xF8, 0xF8, 0x78],
        'S': [0x78, 0xF8, 0x78, 0xF8, 0x78],
        'T': [0x08, 0x08, 0xF8, 0xF8, 0xF8],
        'U': [0xF8, 0xF8, 0xF8, 0xF8, 0x78],
        'V': [0xF8, 0xF8, 0xB8, 0xB8, 0x78],
        'W': [0xF8, 0xF8, 0xD8, 0xD8, 0xF8],
        'X': [0xF8, 0xB8, 0x78, 0xB8, 0xF8],
        'Y': [0xF8, 0xB8, 0x78, 0x78, 0x78],
        'Z': [0xF8, 0xB8, 0x78, 0xD8, 0xF8],
        '?': [0x20, 0x78, 0x78, 0x38, 0x70],
        '!': [0x00, 0x00, 0xF8, 0xF8, 0xF8],
        '%': [0xF8, 0xB8, 0x78, 0xB8, 0xF8],
        '0': [0x78, 0xF8, 0xF8, 0xF8, 0x78],
        '1': [0x78, 0xF8, 0xF8, 0x78, 0x78],
        '2': [0x78, 0xF8, 0x78, 0xF8, 0x78],
        '3': [0x78, 0xF8, 0x78, 0xF8, 0x78],
        '4': [0xF8, 0xF8, 0xF8, 0x00, 0xF8],
        '5': [0xF8, 0xF8, 0x78, 0xF8, 0x78],
        '6': [0x78, 0xF8, 0x78, 0xF8, 0x78],
        '7': [0xF8, 0xF8, 0xF8, 0xF8, 0xF8],
        '8': [0x78, 0xF8, 0x78, 0xF8, 0x78],
        '9': [0x78, 0xF8, 0x78, 0xF8, 0x78],
