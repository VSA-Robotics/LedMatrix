...
namespace LedMatrix {
    ...
    const font: FontMap = {
    'A': [0x00, 0x3E, 0x49, 0x49, 0x3E],  // Fixed 'A'
    'B': [0x00, 0x7E, 0x4A, 0x4A, 0x34],  // Fixed 'B'
    'C': [0x00, 0x3C, 0x42, 0x42, 0x24],  // Fixed 'C' 
    'D': [0x7E, 0x42, 0x42, 0x42, 0x3C],  
    'E': [0x7E, 0x4A, 0x4A, 0x42, 0x42],  
    'F': [0x7E, 0x50, 0x50, 0x40, 0x40],  
    'G': [0x3C, 0x62, 0x42, 0x46, 0x2E],  
    'H': [0x7E, 0x08, 0x08, 0x08, 0x7E],  
    'I': [0x42, 0x42, 0x7E, 0x42, 0x42],  
    'J': [0x06, 0x02, 0x02, 0x7E, 0x40],  
    'K': [0x7E, 0x08, 0x14, 0x22, 0x42],  
    'L': [0x7E, 0x02, 0x02, 0x02, 0x02],  
    'M': [0x7E, 0x30, 0x18, 0x30, 0x7E],  
    'N': [0x7E, 0x30, 0x18, 0x0C, 0x7E],  
    'O': [0x3C, 0x42, 0x42, 0x42, 0x3C],  
    'P': [0x7E, 0x50, 0x50, 0x50, 0x40],  
    'Q': [0x3C, 0x42, 0x46, 0x3E, 0x02],  
