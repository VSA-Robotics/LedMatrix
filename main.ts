...
namespace LedMatrix {
    ...
    const font: FontMap = {
    'A': [0x3E, 0x48, 0x48, 0x48, 0x3E],  // Corrected 'A' like 'H'
    'B': [0x7E, 0x52, 0x52, 0x52, 0x2C],  // Corrected 'B'
    'C': [0x3C, 0x42, 0x42, 0x42, 0x24],  // Corrected 'C'
    'D': [0x7E, 0x42, 0x42, 0x42, 0x3C],  // Corrected 'D'
    'E': [0x7E, 0x52, 0x52, 0x52, 0x42],  // Corrected 'E'
    'F': [0x7E, 0x50, 0x50, 0x50, 0x40],  // Corrected 'F'
    'G': [0x3C, 0x42, 0x52, 0x52, 0x2E],  // Corrected 'G'
    'H': [0x7E, 0x08, 0x08, 0x08, 0x7E],  // Already correct 'H'
    'I': [0x42, 0x42, 0x7E, 0x42, 0x42],  // Corrected 'I'
    'J': [0x02, 0x02, 0x42, 0x7E, 0x40],  // Corrected 'J'
    'K': [0x7E, 0x08, 0x14, 0x22, 0x42],  // Corrected 'K'
    'L': [0x7E, 0x02, 0x02, 0x02, 0x02],  // Corrected 'L'
    'M': [0x7E, 0x20, 0x18, 0x20, 0x7E],  // Corrected 'M'
    'N': [0x7E, 0x20, 0x10, 0x08, 0x7E],  // Corrected 'N'
    'O': [0x3C, 0x42, 0x42, 0x42, 0x3C],  // Corrected 'O'
    'P': [0x7E, 0x50, 0x50, 0x50, 0x40],  // Corrected 'P'
    'Q': [0x3C, 0x42, 0x46, 0x42, 0x3D],  // Corrected 'Q'  
    'R': [0x7E, 0x50, 0x50, 0x4E, 0x42],  
    'S': [0x44, 0x52, 0x52, 0x52, 0x2C],  
    'T': [0x40, 0x40, 0x7E, 0x40, 0x40],  
    'U': [0x7C, 0x02, 0x02, 0x02, 0x7E],  
    'V': [0x78, 0x04, 0x02, 0x04, 0x78],  
    'W': [0x7E, 0x06, 0x0C, 0x06, 0x7E],  
    'X': [0x62, 0x14, 0x08, 0x14, 0x62],  
    'Y': [0x70, 0x08, 0x06, 0x08, 0x70],  
    'Z': [0x46, 0x4A, 0x52, 0x62, 0x42],  
    '0': [0x3C, 0x4A, 0x52, 0x62, 0x3C],  
    '1': [0x04, 0x02, 0x7E, 0x00, 0x00],  
    '2': [0x44, 0x4A, 0x4A, 0x4A, 0x32],  
    '3': [0x42, 0x4A, 0x4A, 0x4A, 0x3C],  
    '4': [0x18, 0x14, 0x12, 0x7E, 0x10],  
    '5': [0x72, 0x52, 0x52, 0x52, 0x4C],  
    '6': [0x3C, 0x52, 0x52, 0x52, 0x4C],  
    '7': [0x42, 0x62, 0x12, 0x0A, 0x06],  
    '8': [0x3C, 0x52, 0x52, 0x52, 0x3C],  
    '9': [0x32, 0x4A, 0x4A, 0x4A, 0x3C],  
    '?': [0x40, 0x68, 0x58, 0x08, 0x10],  
