...
namespace LedMatrix {
    ...
    const font: FontMap = {
    'A': [0x3E, 0x78, 0x78, 0x78, 0x3E],  // Matches intended "A", verified with "HELLO" style
    'B': [0x7E, 0x50, 0x50, 0x4E, 0x40],  // Updated to match your latest "B"
    'C': [0x3C, 0x62, 0x42, 0x40, 0x40],  // Updated to match your latest "C"
