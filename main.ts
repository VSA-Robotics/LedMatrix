...
namespace LedMatrix {
    ...
    const font: FontMap = {
    'A': [0x2E, 0x78, 0x78, 0x78, 0x2E],  // Confirmed
    'B': [0x7E, 0x6A, 0x4A, 0x4A, 0x1E],  // Confirmed
    'C': [0x3C, 0x42, 0x40, 0x42, 0x24],  // Previously adjusted
    'D': [0x7E, 0x62, 0x42, 0x7E, 0x40],  // Confirmed
    'E': [0x7E, 0x4A, 0x4A, 0x4A, 0x42],  // Confirmed
    'F': [0x7E, 0x68, 0x48, 0x48, 0x40],  // Confirmed
    'G': [0x3C, 0x62, 0x42, 0x4E, 0x46],  // Confirmed
    'H': [0x7E, 0x08, 0x08, 0x08, 0x7E],  // Confirmed
    'I': [0x42, 0x42, 0x7E, 0x42, 0x42],  // Confirmed
    'J': [0x42, 0x42, 0x42, 0x7E, 0x40],  // Confirmed
    'K': [0x7E, 0x48, 0x28, 0x44, 0x02],  // Confirmed
    'L': [0x7E, 0x02, 0x02, 0x02, 0x02],  // Confirmed
    'M': [0x7E, 0x48, 0x28, 0x48, 0x7E],  // Confirmed
    'N': [0x7E, 0x48, 0x28, 0x44, 0x1E],  // Confirmed
    'O': [0x3C, 0x42, 0x42, 0x42, 0x3C],  // Confirmed
    'P': [0x7E, 0x68, 0x48, 0x48, 0x40],  // Confirmed
    'Q': [0x3C, 0x60, 0x60, 0x7E, 0x40],  // Confirmed
    'R': [0x7E, 0x68, 0x48, 0x44, 0x40],  // Confirmed
    'S': [0x0A, 0x4A, 0x4A, 0x74, 0x40],  // Confirmed
    'T': [0x40, 0x40, 0x7E, 0x40, 0x40],  // Confirmed
    'U': [0x7C, 0x40, 0x40, 0x40, 0x7E],  // Confirmed
    'V': [0x7C, 0x40, 0x42, 0x40, 0x7C],  // Confirmed
    'W': [0x7C, 0x42, 0x1C, 0x42, 0x7C],  // Confirmed
    'X': [0x42, 0x24, 0x18, 0x24, 0x42],  // Confirmed
    'Y': [0x40, 0x24, 0x7E, 0x24, 0x40],  // Confirmed
    'Z': [0x42, 0x66, 0x56, 0x4A, 0x42],  // Confirmed
    '0': [0x3C, 0x42, 0x42, 0x42, 0x3C],  // Updated
    '1': [0x00, 0x20, 0x7E, 0x00, 0x00],  // Updated
    '2': [0x42, 0x64, 0x54, 0x4C, 0x42],  // Updated
    '3': [0x40, 0x62, 0x54, 0x4E, 0x40],  // Updated
    '4': [0x70, 0x40, 0x1E, 0x40, 0x40],  // Updated
    '5': [0x70, 0x52, 0x52, 0x4E, 0x40],  // Updated
    '6': [0x3C, 0x52, 0x52, 0x52, 0x4C],  // Updated
    '7': [0x42, 0x60, 0x50, 0x48, 0x40],  // Updated
    '8': [0x3C, 0x42, 0x42, 0x42, 0x3C],  // Updated
    '9': [0x42, 0x64, 0x42, 0x52, 0x3C],  // Updated
    '?': [0x40, 0x60, 0x54, 0x40, 0x40],  // Updated
    '!': [0x00, 0x00, 0x7E, 0x00, 0x00],  // Updated
    '%': [0x42, 0x24, 0x18, 0x24, 0x42],  // Updated
    ' ': [0x00, 0x00, 0x00, 0x00, 0x00]   // Unchanged (empty)
};
    ...
    function getMessageBitmap(text: string): number[] {
        ...
        for (let char of text.toUpperCase()) {
            if (font[char]) {
                ...
                bitmap = bitmap.concat(font[' ']); // Use space character
            }
