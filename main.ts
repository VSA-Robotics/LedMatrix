...
namespace LedMatrix {
   ...
   const font: FontMap = {
    ...
    'E': [0x1F, 0x10, 0x1E, 0x10, 0x1F], // Adjusted for upright "E": **** * **** * ****
    'F': [0x3E, 0x20, 0x3C, 0x20, 0x20],
    'G': [0x1C, 0x22, 0x20, 0x26, 0x1A],
    'H': [0x11, 0x11, 0x1F, 0x11, 0x11], // Adjusted for upright "H": * * ***** * *
    'I': [0x1C, 0x08, 0x08, 0x08, 0x1C],
    'J': [0x02, 0x02, 0x02, 0x22, 0x1C],
    'K': [0x22, 0x24, 0x38, 0x24, 0x22],
    'L': [0x10, 0x10, 0x10, 0x10, 0x1F], // Adjusted for upright "L": * * * * ****
    'M': [0x22, 0x36, 0x2A, 0x22, 0x22],
    'N': [0x22, 0x32, 0x2A, 0x26, 0x22],
    'O': [0x0E, 0x11, 0x11, 0x11, 0x0E], // Adjusted for upright "O": * * * **** * * * *
