...
namespace LedMatrix {
    ...
    const font: FontMap = {
    'A': [0x3E, 0x78, 0x78, 0x78, 0x3E],  // Intended: 0***0 *000* *000* ***** *000* *000*
    'B': [0x7E, 0x50, 0x50, 0x4E, 0x40],  // Intended: ****0 *000* ****0 *00*0 *000* ****0
    'C': [0x3C, 0x62, 0x42, 0x40, 0x40],  // Intended: 0***0 *000* *0000 *0000 *000* 0**00
    'D': [0x7E, 0x60, 0x48, 0x4E, 0x40],  // Intended: ****0 *00*0 *000* *000* *00*0 ****0
    'E': [0x7E, 0x4A, 0x4A, 0x4A, 0x42],  // Correct:  ***** *0000 *0000 ****0 *0000 *****
    ...
    'Y': [0x40, 0x24, 0x7E, 0x24, 0x40],
    'Z': [0x42, 0x66, 0x56, 0x4A, 0x42],
