...
namespace LedMatrix {
    ...
    'P': [0x7E, 0x50, 0x50, 0x50, 0x30],  // Fixed 'P' - Clear rounded top, cutoff bottom  
    'Q': [0x3C, 0x42, 0x46, 0x42, 0x3D],  // Fixed 'Q' - Like 'O' but with a tail  
    'R': [0x7E, 0x50, 0x58, 0x54, 0x42],  // Fixed 'R' - Like P but with a diagonal leg  
    'S': [0x44, 0x52, 0x52, 0x52, 0x2C],  // Fixed 'S' - Defined curve shape  
    ...
    '1': [0x00, 0x02, 0x7E, 0x00, 0x00],  
    '2': [0x44, 0x62, 0x52, 0x4A, 0x46],  
    '3': [0x42, 0x4A, 0x4A, 0x4A, 0x36],  
