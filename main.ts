...
namespace LedMatrix {
    ...
    const font: FontMap = {
    'A': [0x3E, 0x78, 0x78, 0x78, 0x3E],  // Corrected (though unchanged, confirming reload issue)
    'B': [0x7E, 0x50, 0x48, 0x40, 0x3E],  // Corrected (though unchanged, confirming reload issue)
    'C': [0x3C, 0x62, 0x42, 0x40, 0x40],  // Corrected
    'D': [0x7E, 0x60, 0x48, 0x4E, 0x40],
    'E': [0x7E, 0x4A, 0x4A, 0x4A, 0x42],
    'F': [0x7E, 0x50, 0x50, 0x40, 0x40],
    'G': [0x3C, 0x62, 0x42, 0x4E, 0x46],
    'H': [0x7E, 0x08, 0x08, 0x08, 0x7E],
    'I': [0x42, 0x42, 0x7E, 0x42, 0x42],
    'J': [0x42, 0x42, 0x42, 0x7E, 0x40],
    'K': [0x7E, 0x48, 0x28, 0x44, 0x02],
    'L': [0x7E, 0x02, 0x02, 0x02, 0x02],
    'M': [0x7E, 0x48, 0x28, 0x48, 0x7E],
    'N': [0x7E, 0x48, 0x28, 0x44, 0x1E],
    'O': [0x3C, 0x42, 0x42, 0x42, 0x3C],
    'P': [0x7E, 0x50, 0x50, 0x40, 0x40],
    'Q': [0x3C, 0x60, 0x60, 0x7E, 0x40],
    'R': [0x7E, 0x50, 0x50, 0x40, 0x3E],
    'S': [0x48, 0x74, 0x54, 0x44, 0x40],
    'T': [0x40, 0x40, 0x7E, 0x40, 0x40],
    'U': [0x7C, 0x40, 0x40, 0x40, 0x7E],
    'V': [0x7C, 0x40, 0x42, 0x40, 0x7C],
    'W': [0x7C, 0x40, 0x5C, 0x40, 0x7C],
    'X': [0x42, 0x24, 0x18, 0x24, 0x42],
    'Y': [0x40, 0x24, 0x7E, 0x24, 0x40],  // Corrected (though unchanged, confirming reload issue)
    'Z': [0x42, 0x66, 0x56, 0x4A, 0x42],  // Corrected (though unchanged, confirming reload issue)
    '0': [0x3C, 0x42, 0x42, 0x42, 0x3C],
    '1': [0x00, 0x00, 0x7E, 0x00, 0x00],
    '2': [0x48, 0x44, 0x64, 0x42, 0x7E],
    '3': [0x40, 0x62, 0x54, 0x4E, 0x40],
    '4': [0x70, 0x40, 0x1E, 0x40, 0x40],
    '5': [0x70, 0x52, 0x52, 0x4E, 0x40],
    '6': [0x3C, 0x52, 0x52, 0x52, 0x4C],
    '7': [0x42, 0x60, 0x50, 0x48, 0x40],
    '8': [0x3C, 0x42, 0x42, 0x42, 0x3C],
    '9': [0x42, 0x64, 0x42, 0x52, 0x3C],
    '?': [0x40, 0x60, 0x54, 0x40, 0x40],
