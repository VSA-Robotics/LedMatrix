...
namespace LedMatrix {
    ...
    'B': [0x3E, 0x33, 0x33, 0x3E, 0x33, 0x33, 0x3E, 0x00],  // B
    'C': [0x1E, 0x33, 0x30, 0x30, 0x30, 0x33, 0x1E, 0x00],  // C
    'D': [0x3E, 0x33, 0x33, 0x33, 0x33, 0x33, 0x3E, 0x00],  // D
    'E': [0x3F, 0x30, 0x30, 0x3E, 0x30, 0x30, 0x3F, 0x00],  // E
    'F': [0x3F, 0x30, 0x30, 0x3E, 0x30, 0x30, 0x30, 0x00],  // F
    'G': [0x1E, 0x30, 0x30, 0x37, 0x33, 0x33, 0x1E, 0x00],  // G
    'H': [0x33, 0x33, 0x33, 0x3F, 0x33, 0x33, 0x33, 0x00],  // H
    'I': [0x1E, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x1E, 0x00],  // I
    'J': [0x07, 0x03, 0x03, 0x03, 0x33, 0x33, 0x1E, 0x00],  // J
    'K': [0x33, 0x36, 0x3C, 0x38, 0x3C, 0x36, 0x33, 0x00],  // K
    'L': [0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x3F, 0x00],  // L
    'M': [0x33, 0x3F, 0x3F, 0x3F, 0x33, 0x33, 0x33, 0x00],  // M
    'N': [0x33, 0x33, 0x3B, 0x3F, 0x37, 0x33, 0x33, 0x00],  // N
    'O': [0x1E, 0x33, 0x33, 0x33, 0x33, 0x33, 0x1E, 0x00],  // O
    'P': [0x3E, 0x33, 0x33, 0x3E, 0x30, 0x30, 0x30, 0x00],  // P
    'Q': [0x1E, 0x33, 0x33, 0x33, 0x37, 0x3E, 0x07, 0x00],  // Q
    'R': [0x3E, 0x33, 0x33, 0x3E, 0x36, 0x33, 0x33, 0x00],  // R
    'S': [0x1E, 0x33, 0x30, 0x1E, 0x03, 0x33, 0x1E, 0x00],  // S
    'T': [0x3F, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x00],  // T
    'U': [0x33, 0x33, 0x33, 0x33, 0x33, 0x33, 0x1E, 0x00],  // U
    'V': [0x33, 0x33, 0x33, 0x33, 0x33, 0x1E, 0x0C, 0x00],  // V
    'W': [0x33, 0x33, 0x33, 0x3F, 0x3F, 0x3F, 0x33, 0x00],  // W
    'X': [0x33, 0x33, 0x1E, 0x0C, 0x1E, 0x33, 0x33, 0x00],  // X
    'Y': [0x33, 0x33, 0x33, 0x1E, 0x0C, 0x0C, 0x0C, 0x00],  // Y
    'Z': [0x3F, 0x03, 0x06, 0x0C, 0x18, 0x30, 0x3F, 0x00],  // Z
    '0': [0x1E, 0x33, 0x37, 0x3F, 0x3B, 0x33, 0x1E, 0x00],  // 0
    '1': [0x0C, 0x1C, 0x0C, 0x0C, 0x0C, 0x0C, 0x1E, 0x00],  // 1
    '2': [0x1E, 0x33, 0x03, 0x0E, 0x18, 0x30, 0x3F, 0x00],  // 2
    '3': [0x1E, 0x33, 0x03, 0x0E, 0x03, 0x33, 0x1E, 0x00],  // 3
    '4': [0x06, 0x0E, 0x1E, 0x36, 0x3F, 0x06, 0x06, 0x00],  // 4
    '5': [0x3F, 0x30, 0x3E, 0x03, 0x03, 0x33, 0x1E, 0x00],  // 5
    '6': [0x1E, 0x33, 0x30, 0x3E, 0x33, 0x33, 0x1E, 0x00],  // 6
    '7': [0x3F, 0x03, 0x06, 0x0C, 0x18, 0x18, 0x18, 0x00],  // 7
};
